...
def calculate():
    ...
    try:
        ...
        calc_data = {
            ...
            "Расход топливо (CV)": V_топливо_cv,
...
# === Настройка сетки ===
root.grid_columnconfigure(0, weight=1)  # Форма ввода
root.grid_columnconfigure(1, weight=2)  # График
root.grid_rowconfigure(0, weight=1)     # Основной контент
